...
testgen = DataGenerator(list_IDs, test_paths[1][0],test_paths[1][1], to_fit=True, batch_size=2, dim=(512, 512),dimy=(512, 512), n_channels=1, n_classes=2, shuffle=True)
######### 3D generators ###########
...
testgen3d = generator3d(list_IDs, test_paths[2][0],test_paths[2][1], to_fit=True, batch_size=1, patch_size=8, dim=(128, 128), dimy=(128,128), n_channels=1, n_classes=2, shuffle=True)
############# models ##############
