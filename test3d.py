...
'''list_IDs = os.listdir("C:/Datasets/elderlymen1/2d/images")
gen = DataGenerator(list_IDs, "C:/Datasets/elderlymen1/2d/images","C:/Datasets/elderlymen1/2d/FASCIA_FILLED", to_fit=True, batch_size=2, dim=(512, 512),dimy=(512, 512), n_channels=1, n_classes=2, shuffle=True)
gen.downsample((256,256),"C:/Datasets/elderlymen1/3dmedium")
reorderframes('C:/Datasets/elderlymen1/3dmedium/images','C:/Datasets/elderlymen1/3dmedium/masks',
              'C:/Datasets/elderlymen1/3dmedium/image','C:/Datasets/elderlymen1/3dmedium/mask',28,72)
...
#testgen3d = generator3d(list_IDs, test_paths[2][0],test_paths[2][1], to_fit=True, batch_size=1, patch_size=4, dim=(512, 512), dimy=(512,512), n_channels=1, n_classes=2, shuffle=False)
...
#model = unet3d( pretrained_weights='unet_ThighOuterSurface.hdf5',input_size=(512, 512,2, 1))
model = unet3d(input_size=(256, 256, 4,1))
history = model.fit_generator(generator=gen3da, validation_data=gen3d, validation_steps=len(gen3d), steps_per_epoch=len(gen3da), epochs=15, callbacks=[model_checkpoint2, model_checkpoint])
######### predict and save ###########
